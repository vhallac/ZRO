...
local obj = uOO:NewClass("ScrollFrame",
                         {
                         })
...
--]]
function obj:Construct(scrollframe, buttonTemplateName, model)
...
function obj:GetFirstItemIndex()
    return FauxScrollFrame_GetOffset(self.scroller) or 0
end

function obj:GetDisplayedItemCount()
...
function obj:OnItemChanged(itemIdx)
...
function obj:SetItemCount(itemCount)
